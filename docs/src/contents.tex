...
\begin{figure}[h]
\centering
\subfigure[Valores bajos de H.]{\includegraphics[width=0.35\textwidth]{images/rojo1.jpg} }
\subfigure[Valores altos de H.]{\includegraphics[width=0.35\textwidth]{images/rojo2.jpg} }
\subfigure[Suma de los dos anteriores]{\includegraphics[width=0.7\textwidth]{images/rojo.jpg} }
